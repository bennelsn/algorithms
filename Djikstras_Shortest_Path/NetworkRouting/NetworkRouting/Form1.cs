...
namespace NetworkRouting
{
    public partial class Form1 : Form
    {
        ...
        public void solveButton_Clicked()
        {
            ...
            MyPathSolver myPathSolver = new MyPathSolver(graphics, pictureBox, pathCostBox);
            ...
            if(arrayCheckBox.Checked == true)
            {
                ...
                //ARRAY************************************************************************
                //Start Array Stop Watch
                arrayTimer.Start();
                myPathSolver.SolveArray(points, adjacencyList, startNodeIndex, stopNodeIndex);
                pictureBox.Refresh();
                arrayTimer.Stop();
                //Array Stop Watch STOPPED

                //OUTPUT TIMES
                arrayTimeBox.Text = "" + arrayTimer.Elapsed;
                double arrayTime = arrayTimer.Elapsed.TotalSeconds;
                ...
                //HEAP************************************************************************
                //Start Heap Stop Watch
                heapTimer.Start();
                myPathSolver.SolveHeap(points, adjacencyList, startNodeIndex, stopNodeIndex);
                pictureBox.Refresh();
                heapTimer.Stop();
                //Array Stop Watch STOPPED

                //OUTPUT TIMES
                heapTimeBox.Text = "" + heapTimer.Elapsed;
                double heapTime = heapTimer.Elapsed.TotalSeconds;
                ...
                if (heapTime != 0)
                {
                    double xSpeedUp = (arrayTime / heapTime);
                    differenceBox.Text = xSpeedUp.ToString();
                }
                else
                {
                    differenceBox.Text = "Heap 0";
                }
